...
- **Tags:** `Products`
- **Required bearer scopes:** `access_pass:create`, `access_pass:basic:read`
...
properties:
  ...
  plan_options:
    ...
    properties:
      ...
      initial_price:
        ...
        - number
        - 'null'
        description: 'An additional amount charged upon first purchase. Provided as
          a number in the specified currency. Eg: 10.43 for $10.43 USD.'
        example: 6.9
      plan_type:
        oneOf:
    ...
    required: []
    description: Configuration for an automatically generated plan to attach to this
      product.
  product_tax_code_id:
    type:
    - string
  ...
  send_welcome_message:
    ...
    description: Whether to send an automated welcome message via support chat when
      a user joins this product. Defaults to true.
  title:
    type: string
              ...
              properties:
                ...
                experience_ids:
                  ...
                  items:
                    ...
                    description: Represents a unique identifier that is Base64 obfuscated.
                      ...
                      (such as `4`) input value will be accepted as an ID.
                  description: The unique identifiers of experiences to connect to
                    this product.
                global_affiliate_percentage:
                  type:
                  - number
                ...
                plan_options:
                  ...
                  properties:
                    ...
                    billing_period:
                      ...
                      - integer
                      - 'null'
                      description: The interval at which the plan charges (renewal
                        plans).
                      example: 42
                    custom_fields:
                      type:
                    ...
                    release_method:
                      ...
                      - "$ref": "#/components/schemas/ReleaseMethod"
                      - type: 'null'
                      description: The method by which the plan is released to the
                        public.
                    renewal_price:
                      type:
                      - number
                      ...
                      description: 'The amount the customer is charged every billing
                        period. Provided as a number in the specified currency. Eg:
                        10.43 for $10.43 USD.'
                      example: 6.9
                    visibility:
                      oneOf:
                      ...
                      description: The visibility of the plan.
                  required: []
                  description: Configuration for an automatically generated plan to
                ...
                send_welcome_message:
                  ...
                  description: Whether to send an automated welcome message via support
                    chat when a user joins this product. Defaults to true.
                title:
                  type: string
                  description: The display name of the product. Maximum 80 characters.
                visibility:
