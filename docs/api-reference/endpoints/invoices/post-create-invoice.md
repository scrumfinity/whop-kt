...
- **Tags:** `Invoices`
- **Required bearer scopes:** `invoice:create`
...
- type: object
  properties:
    ...
    product:
      ...
      required:
      - title
      description: The properties of the product to create for this invoice. Provide
        this to create a new product inline.
    customer_name:
      type:
      - string
      - 'null'
      description: The name of the customer. Required when creating an invoice for
        a customer who is not yet a member of the company.
    email_address:
      type:
      - string
      - 'null'
      description: The email address of the customer. Required when creating an invoice
        for a customer who is not yet a member of the company.
    member_id:
      type:
      - string
      - 'null'
      description: The unique identifier of an existing member to create this invoice
        for. If not provided, you must supply an email_address and customer_name.
    ...
    plan:
      ...
      properties:
        ...
        expiration_days:
          ...
          - integer
          - 'null'
          description: The number of days until the membership expires and revokes
            access (expiration plans). For example, 365 for a one-year access period.
          example: 42
        initial_price:
          type:
          - number
          - 'null'
          description: 'An additional amount charged upon first purchase. Use only
            if a one time payment OR you want to charge an additional amount on top
            of the renewal price. Provided as a number in the specified currency.
            Eg: 10.43 for $10.43'
          example: 6.9
        internal_notes:
          type:
      ...
      required: []
      description: The plan attributes defining the price, currency, and billing interval
        for this invoice.
    collection_method:
      "$ref": "#/components/schemas/InvoiceCollectionMethods"
      description: How the invoice should be collected. Use charge_automatically to
        charge a stored payment method, or send_invoice to email the customer.
    due_date:
      type:
      - string
      - 'null'
      format: date-time
      description: The date by which the invoice must be paid. Required unless save_as_draft
        is true.
    ...
    automatically_finalizes_at:
      ...
      description: The date and time when the invoice will be automatically finalized.
        For charge_automatically, triggers an automatic charge. For send_invoice,
        sends the invoice email to the customer at the specified time.
      example: '2023-12-01T05:00:00.401Z'
    billing_address:
      type:
      - object
      ...
      required: []
      description: Inline billing address to create a new mailing address for this
        invoice. Cannot be used together with mailing_address_id.
    charge_buyer_fee:
      type:
      - boolean
      - 'null'
    ...
    line_items:
      ...
      items:
        ...
        properties:
          ...
          unit_price:
            type: number
            description: 'The unit price for this line item. Provided as a number
        ...
        description: A single line item to include on the invoice, with a label, quantity,
          and unit price.
      description: Optional line items that break down the invoice total. When provided,
        the sum of (quantity * unit_price) for all items must equal the plan price.
    mailing_address_id:
      type:
      - string
      - 'null'
      description: The unique identifier of an existing mailing address to attach
        to this invoice. Cannot be used together with billing_address.
      example: ma_xxxxxxxxxxxxxxx
    payment_method_id:
      type:
      - string
      - 'null'
      description: The unique identifier of the payment method to charge. Required
        when collection_method is charge_automatically.
      example: payt_xxxxxxxxxxxxx
    payment_token_id:
      type:
      - string
      - 'null'
      description: The payment token ID to use for this invoice. If using charge_automatically,
        you must provide a payment_token.
      example: payt_xxxxxxxxxxxxx
    save_as_draft:
      type:
      - boolean
      - 'null'
      description: When true, creates the invoice as a draft without sending or charging.
    ...
    subscription_billing_anchor_at:
      ...
      description: The date that defines when the subscription billing cycle should
        start. When set on a renewal plan invoice, this anchors all future billing
...
- type: object
  properties:
    ...
    product_id:
      type: string
      description: The unique identifier of an existing product to create this invoice
        for.
            ...
            schema:
                ...
                properties:
                  ...
                  product:
                    ...
                    properties:
                      product_tax_code_id:
                        ...
                        - string
                        - 'null'
                        description: The ID of the product tax code to apply to this
                          product.
                        example: ptc_xxxxxxxxxxxxxx
                      title:
                        type: string
                    ...
                    required:
                    - title
                    description: The properties of the product to create for this
                      invoice. Provide this to create a new product inline.
                  customer_name:
                    type:
                    - string
                    - 'null'
                    description: The name of the customer. Required when creating
                      an invoice for a customer who is not yet a member of the company.
                  email_address:
                    type:
                    - string
                    - 'null'
                    description: The email address of the customer. Required when
                      creating an invoice for a customer who is not yet a member of
                      the company.
                  member_id:
                    type:
                    - string
                    - 'null'
                    description: The unique identifier of an existing member to create
                      this invoice for. If not provided, you must supply an email_address
                      and customer_name.
                    example: mber_xxxxxxxxxxxxx
                  plan:
                    type: object
                    properties:
                      ...
                      expiration_days:
                        ...
                        description: The number of days until the membership expires
                          and revokes access (expiration plans). For example, 365
                      ...
                      initial_price:
                        ...
                        description: 'An additional amount charged upon first purchase.
                          Use only if a one time payment OR you want to charge an
                      ...
                      legacy_payment_method_controls:
                        ...
                        - boolean
                        - 'null'
                        description: Whether this plan uses legacy payment method
                          controls
                      payment_method_configuration:
                        type:
                        - object
                      ...
                      unlimited_stock:
                        ...
                        description: When true, the plan has unlimited stock (stock
                          field is ignored). When false, purchases are limited by
                          the stock field.
                      visibility:
                        oneOf:
                        - "$ref": "#/components/schemas/Visibility"
                        ...
                        description: Shows or hides the plan from public/business
                          view.
                    required: []
                    description: The plan attributes defining the price, currency,
                      and billing interval for this invoice.
                  collection_method:
                    "$ref": "#/components/schemas/InvoiceCollectionMethods"
                    description: How the invoice should be collected. Use charge_automatically
                      to charge a stored payment method, or send_invoice to email
                      the customer.
                  due_date:
                    type:
                    - string
                    - 'null'
                    format: date-time
                    description: The date by which the invoice must be paid. Required
                  ...
                  automatically_finalizes_at:
                    ...
                    description: The date and time when the invoice will be automatically
                      ...
                      For send_invoice, sends the invoice email to the customer at
                      the specified time.
                    example: '2023-12-01T05:00:00.401Z'
                  billing_address:
                    type:
                    ...
                    properties:
                      ...
                      tax_id_value:
                        ...
                        description: The value of the tax identifier.
                    required: []
                    description: Inline billing address to create a new mailing address
                      for this invoice. Cannot be used together with mailing_address_id.
                  charge_buyer_fee:
                    type:
                    - boolean
                    - 'null'
                  ...
                  line_items:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        quantity:
                          ...
                          - number
                          - 'null'
                          description: The quantity of this line item. Defaults to
                            1.
                          example: 6.9
                        unit_price:
                          type: number
                    ...
                    description: Optional line items that break down the invoice total.
                      When provided, the sum of (quantity * unit_price) for all items
                      must equal the plan price.
                  mailing_address_id:
                    type:
                    - string
                    - 'null'
                    description: The unique identifier of an existing mailing address
                      to attach to this invoice. Cannot be used together with billing_address.
                    example: ma_xxxxxxxxxxxxxxx
                  payment_method_id:
                    type:
                    - string
                  ...
                  payment_token_id:
                    ...
                    - string
                    - 'null'
                    description: The payment token ID to use for this invoice. If
                      using charge_automatically, you must provide a payment_token.
                    example: payt_xxxxxxxxxxxxx
                  save_as_draft:
                    type:
                    - boolean
                    - 'null'
                    description: When true, creates the invoice as a draft without
                      sending or charging. Relaxes customer and due date requirements.
                  subscription_billing_anchor_at:
                    type:
                    - string
                    - 'null'
                    ...
                    description: The date that defines when the subscription billing
                      cycle should start. When set on a renewal plan invoice, this
                      anchors all future billing periods to this date.
                    example: '2023-12-01T05:00:00.401Z'
                required:
                - company_id
                - plan
              ...
              - type: object
                properties:
                  ...
                  product_id:
                    type: string
                    description: The unique identifier of an existing product to create
                      this invoice for.
                    example: prod_xxxxxxxxxxxxx
                  customer_name:
                    type:
