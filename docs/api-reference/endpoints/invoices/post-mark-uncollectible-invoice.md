# POST /invoices/{id}/mark_uncollectible — Mark uncollectible invoice
...
- **Operation ID:** `markUncollectibleInvoice`
- **Tags:** `Invoices`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the invoice to mark as uncollectible. | inv_xxxxxxxxxxxxxx |
