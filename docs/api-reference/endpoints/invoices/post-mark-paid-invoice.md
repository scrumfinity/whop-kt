# POST /invoices/{id}/mark_paid — Mark paid invoice

Generated from Whop's official documented OpenAPI source: [openapi.documented.yml](../../openapi.documented.yml).

- **Base URL:** `https://api.whop.com/api/v1`
- **Method:** `POST`
- **Path:** `/invoices/{id}/mark_paid`
- **Operation ID:** `markPaidInvoice`
- **Tags:** `Invoices`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the invoice to mark as paid. | inv_xxxxxxxxxxxxxx |
