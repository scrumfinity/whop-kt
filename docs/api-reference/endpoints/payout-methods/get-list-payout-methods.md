# GET /payout_methods — List payout methods
...
| `company_id` | query | yes | `string` | The unique identifier of the company to list payout methods for. | biz_xxxxxxxxxxxxxx |
  ...
  "/payout_methods":
    get:
      ...
      - name: company_id
        ...
        schema:
          type: string
          description: The unique identifier of the company to list payout methods
            for.
          example: biz_xxxxxxxxxxxxxx
        explode: true
        style: form
