# DELETE /course_chapters/{id} — Delete course chapter
...
- **Operation ID:** `deleteCourseChapter`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the chapter to delete (e.g., "chap_XXXXX"). | chap_xxxxxxxxxxxxx |
