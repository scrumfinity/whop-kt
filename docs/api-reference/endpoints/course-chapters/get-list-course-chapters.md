# GET /course_chapters — List course chapters
...
- **Operation ID:** `listCourseChapter`
...
| `course_id` | query | yes | `string` | The unique identifier of the course to list chapters for. | cors_xxxxxxxxxxxxx |
