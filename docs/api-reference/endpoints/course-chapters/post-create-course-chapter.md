# POST /course_chapters — Create course chapter
...
- **Operation ID:** `createCourseChapter`
...
properties:
  course_id:
    type: string
    description: The unique identifier of the course to create the chapter in (e.g.,
      "course_XXXXX").
          ...
          application/json:
            schema:
              ...
              properties:
                course_id:
                  type: string
                  description: The unique identifier of the course to create the chapter
                    in (e.g., "course_XXXXX").
                  example: cors_xxxxxxxxxxxxx
                title:
                  type:
                  - string
                  - 'null'
                  description: 'The display title of the chapter (e.g., "Module 1:
                    Introduction").'
              required:
              - course_id
              description: Parameters for CreateChapter
