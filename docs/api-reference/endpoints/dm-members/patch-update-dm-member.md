# PATCH /dm_members/{id} — Update dm member
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the DM channel member to update. |  |
...
properties:
  notification_preference:
    ...
    - type: 'null'
    description: The notification setting for this member, controlling how they receive
      alerts for new messages in this channel.
  status:
    oneOf:
            ...
            schema:
              ...
              properties:
                notification_preference:
                  ...
                  - "$ref": "#/components/schemas/DmsFeedMemberNotificationPreferences"
                  - type: 'null'
                  description: The notification setting for this member, controlling
                    how they receive alerts for new messages in this channel.
                status:
                  oneOf:
                  - "$ref": "#/components/schemas/DmsFeedMemberStatuses"
                  - type: 'null'
