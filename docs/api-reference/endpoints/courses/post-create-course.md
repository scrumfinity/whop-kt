...
properties:
  ...
  experience_id:
    type: string
    description: The unique identifier of the experience to create the course in (e.g.,
      "exp_XXXXX").
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                experience_id:
                  type: string
                  description: The unique identifier of the experience to create the
                    course in (e.g., "exp_XXXXX").
                  example: exp_xxxxxxxxxxxxxx
                order:
                  type:
                  - string
