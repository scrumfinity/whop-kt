# PATCH /dm_channels/{id} — Update dm channel
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the DM channel to update. |  |
...
properties:
  custom_name:
    ...
    - string
    - 'null'
    description: A new custom display name for the DM channel. For example, 'Project
      Discussion'.
required: []
            ...
            schema:
              ...
              properties:
                custom_name:
                  ...
                  - string
                  - 'null'
                  description: A new custom display name for the DM channel. For example,
                    'Project Discussion'.
              required: []
              description: Parameters for UpdateDmChannel
      x-codeSamples:
