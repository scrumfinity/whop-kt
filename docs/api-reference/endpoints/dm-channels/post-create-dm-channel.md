# POST /dm_channels — Create dm channel
...
properties:
  company_id:
    ...
    - string
    - 'null'
    description: The unique identifier of the company to scope this DM channel to.
  ...
  with_user_ids:
    ...
    description: The list of user identifiers to include in the DM channel. Each entry
      can be an email, username, or user ID (e.g. 'user_xxxxx').
required:
- with_user_ids
...
|---|---|---|---|
| `200` | A successful response | `application/json` | `DmChannel` |
...
paths:
  "/dm_channels":
    post:
      ...
      description: Create a new DM channel between two or more users, optionally scoped
        to a specific company. Returns the existing channel if one already exists.
      parameters: []
            ...
            schema:
              ...
              properties:
                company_id:
                  ...
                  - string
                  - 'null'
                  description: The unique identifier of the company to scope this
                    DM channel to. When set, the channel is visible only within that
                    company context.
                  example: biz_xxxxxxxxxxxxxx
                custom_name:
                  type:
                  - string
                  - 'null'
                  description: A custom display name for the DM channel. For example,
                    'Project Discussion'.
                with_user_ids:
                  type: array
                  items:
                    ...
                    description: Represents a unique identifier that is Base64 obfuscated.
                      ...
                      (such as `4`) input value will be accepted as an ID.
                  description: The list of user identifiers to include in the DM channel.
  ...
  schemas:
    DmChannel:
      ...
      properties:
        ...
        created_at:
          type: string
          description: The time the entity was created (in milliseconds since Unix
            epoch)
          example: '1727606400000'
        name:
          type:
