# GET /dm_channels — List dm channels
...
| `company_id` | query | no | `string \| null` | The unique identifier of a company to filter DM channels by. Only returns channels scoped to this company. | biz_xxxxxxxxxxxxxx |
    ...
    get:
      ...
      - name: company_id
        ...
        schema:
          ...
          - string
          - 'null'
          description: The unique identifier of a company to filter DM channels by.
