# GET /app_builds/{id} — Retrieve app build
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the app build to retrieve. | apbu_xxxxxxxxxxxxx |
