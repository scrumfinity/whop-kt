...
- **Method:** `GET`
- **Path:** `/apps/{id}`
- **Operation ID:** `retrieveApp`
- **Tags:** `Apps`
- **Required bearer scopes:** `developer:manage_api_key`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the app to retrieve. | app_xxxxxxxxxxxxxx |
