...
| `company_id` | query | yes | `string` | The unique identifier of the company to list forums for. | biz_xxxxxxxxxxxxxx |
| `product_id` | query | no | `string \| null` | The unique identifier of a product to filter by. When set, only forums connected to this product are returned. | prod_xxxxxxxxxxxxx |
      ...
      - name: product_id
        ...
        schema:
          ...
          description: The unique identifier of a product to filter by. When set,
            only forums connected to this product are returned.
