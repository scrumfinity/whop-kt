# POST /disputes/{id}/submit_evidence — Submit evidence

Generated from Whop's official documented OpenAPI source: [openapi.documented.yml](../../openapi.documented.yml).

- **Base URL:** `https://api.whop.com/api/v1`
- **Method:** `POST`
- **Path:** `/disputes/{id}/submit_evidence`
- **Operation ID:** `submitEvidenceDispute`
- **Tags:** `Disputes`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the dispute to submit to the payment processor for review. | dspt_xxxxxxxxxxxxx |
  ...
  "/disputes/{id}/submit_evidence":
    post:
      ...
      - name: id
        in: path
        required: true
        description: The unique identifier of the dispute to submit to the payment
