# GET /checkout_configurations — List checkout configurations
...
- **Operation ID:** `listCheckoutConfiguration`
...
| `company_id` | query | yes | `string` | The unique identifier of the company to list checkout configurations for. | biz_xxxxxxxxxxxxxx |
| `direction` | query | no | `Direction \| null` | The sort direction for ordering results, either ascending or descending. |  |
| `plan_id` | query | no | `string \| null` | Filter checkout configurations to only those associated with this plan identifier. | plan_xxxxxxxxxxxxx |
| `created_before` | query | no | `string \| null / date-time` | Only return checkout configurations created before this timestamp. | 2023-12-01T05:00:00.401Z |
| `created_after` | query | no | `string \| null / date-time` | Only return checkout configurations created after this timestamp. | 2023-12-01T05:00:00.401Z |
  ...
  "/checkout_configurations":
    get:
      ...
      - name: company_id
        ...
        schema:
          type: string
          description: The unique identifier of the company to list checkout configurations
            for.
      ...
      - name: plan_id
        ...
        schema:
          ...
          - string
          - 'null'
          description: Filter checkout configurations to only those associated with
