...
| `payout_account_id` | query | yes | `string` | The unique identifier of the payout account to list verifications for. | poact_xxxxxxxxxxxx |
  ...
  "/verifications":
    get:
      ...
      - name: payout_account_id
        ...
        schema:
          type: string
          description: The unique identifier of the payout account to list verifications
            for.
