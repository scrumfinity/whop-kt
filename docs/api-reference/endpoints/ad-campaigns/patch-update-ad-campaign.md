# PATCH /ad_campaigns/{id} — Update ad campaign
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the ad campaign to update. | adcamp_xxxxxxxxxxx |
...
properties:
  ...
  daily_budget:
    ...
    - number
    - 'null'
    description: Daily budget in dollars (minimum $5).
    example: 6.9
  product_id:
    type:
    - string
    - 'null'
    description: The unique identifier of the product (access pass) to promote.
            ...
            schema:
              ...
              properties:
                ...
                product_id:
                  ...
                  - string
                  - 'null'
                  description: The unique identifier of the product (access pass)
                    to promote.
                  example: prod_xxxxxxxxxxxxx
                target_country_codes:
                  type:
