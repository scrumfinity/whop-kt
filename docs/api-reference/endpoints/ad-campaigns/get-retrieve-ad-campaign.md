# GET /ad_campaigns/{id} — Retrieve ad campaign
...
- **Operation ID:** `retrieveAdCampaign`
- **Tags:** `Ad campaigns`
- **Required bearer scopes:** `ad_campaign:basic:read`, `access_pass:basic:read`, `company:balance:read`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the ad campaign. | adcamp_xxxxxxxxxxx |
