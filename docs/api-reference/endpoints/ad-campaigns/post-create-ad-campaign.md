# POST /ad_campaigns — Create ad campaign
...
- **Method:** `POST`
- **Path:** `/ad_campaigns`
- **Operation ID:** `createAdCampaign`
- **Tags:** `Ad campaigns`
- **Required bearer scopes:** `ad_campaign:create`, `access_pass:basic:read`, `company:balance:read`
...
properties:
  ad_creative_set_ids:
    ...
    description: Array of creative set IDs to link to this campaign.
  budget:
    type:
    - number
    - 'null'
  ...
  company_id:
    type: string
    description: The company ID to create this ad campaign for.
  ...
  config:
    ...
    properties:
      objective:
        ...
        - type: 'null'
        description: The campaign objective that determines how Meta optimizes delivery.
      bid_strategy:
        oneOf:
      ...
      lifetime_budget:
        ...
        - integer
        - 'null'
        description: Represents non-fractional signed whole numeric values. Int can
    ...
    required: []
    description: Unified campaign configuration (conversion goal, budget, bidding,
      etc.).
  daily_budget:
    type:
    - number
    - 'null'
    description: Daily budget in dollars (minimum $5). Required unless lifetime_budget
      is set in config.
    example: 6.9
  platform:
    "$ref": "#/components/schemas/AdCampaignPlatforms"
    description: The ad platform to run on (e.g., meta, tiktok).
  product_id:
    type:
    - string
    - 'null'
  ...
  title:
    type: string
    description: The title of the ad campaign. Must be max 100 characters.
required:
- company_id
- config
- platform
- title
description: Parameters for CreateAdCampaignV2
```
...
ad_campaign = whop.ad_campaigns.create(company_id: "biz_xxxxxxxxxxxxxx", config: {}, platform: :meta, title: "title")
                ...
                config:
                  ...
                  properties:
                    objective:
                      ...
                      - "$ref": "#/components/schemas/CampaignConfigObjective"
                      - type: 'null'
                      description: The campaign objective that determines how Meta
                        optimizes delivery.
                    bid_strategy:
                      oneOf:
                      - "$ref": "#/components/schemas/CampaignConfigBidStrategy"
                      - type: 'null'
                      description: The bidding strategy used to optimize spend for
                        this campaign.
                    bid_amount:
                      type:
                      - integer
                      - 'null'
                      description: Bid cap amount in cents. Only used when bid_strategy
                        is bid_cap.
                      example: 42
                    status:
                      oneOf:
                      - "$ref": "#/components/schemas/CampaignConfigStatus"
                      - type: 'null'
                      description: The campaign status as set by the advertiser (active
                        or paused).
                    special_categories:
                      type:
                      - array
                      ...
                      items:
                        ...
                        description: Represents textual data as UTF-8 character sequences.
                          ...
                          human-readable text.
                      description: Special ad categories required by the platform
                    ...
                    end_time:
                      ...
                      description: The scheduled end time of the campaign (ISO8601).
                  required: []
                  description: Unified campaign configuration (conversion goal, budget,
                    bidding, etc.).
                daily_budget:
                  type:
                  - number
                  - 'null'
                  description: Daily budget in dollars (minimum $5). Required unless
                    lifetime_budget is set in config.
                  example: 6.9
                platform:
                  "$ref": "#/components/schemas/AdCampaignPlatforms"
                  description: The ad platform to run on (e.g., meta, tiktok).
