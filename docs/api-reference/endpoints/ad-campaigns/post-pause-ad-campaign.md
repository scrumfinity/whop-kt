# POST /ad_campaigns/{id}/pause — Pause ad campaign

Generated from Whop's official documented OpenAPI source: [openapi.documented.yml](../../openapi.documented.yml).

- **Base URL:** `https://api.whop.com/api/v1`
- **Method:** `POST`
- **Path:** `/ad_campaigns/{id}/pause`
- **Operation ID:** `pauseAdCampaign`
- **Tags:** `Ad campaigns`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the ad campaign to pause. | adcamp_xxxxxxxxxxx |
...
const response = await client.adCampaigns.pause('adcamp_xxxxxxxxxxx');
...
response = client.ad_campaigns.pause(
    "adcamp_xxxxxxxxxxx",
)
print(response.id)
```
