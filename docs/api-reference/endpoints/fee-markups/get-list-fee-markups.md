# GET /fee_markups — List fee markups
...
| `company_id` | query | yes | `string` | The unique identifier of the company to list fee markups for. Pass a platform account identifier to retrieve platform default markups. | biz_xxxxxxxxxxxxxx |
  ...
  "/fee_markups":
    get:
      ...
      - name: company_id
        ...
        schema:
          type: string
          description: The unique identifier of the company to list fee markups for.
