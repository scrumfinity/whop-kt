...
- **Method:** `GET`
- **Path:** `/payments/{id}`
- **Operation ID:** `retrievePayment`
- **Tags:** `Payments`
- **Required bearer scopes:** `payment:basic:read`, `plan:basic:read`, `access_pass:basic:read`, `member:email:read`, `member:basic:read`, `member:phone:read`, `promo_code:basic:read`, `payment:dispute:read`, `payment:resolution_center_case:read`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the payment. | pay_xxxxxxxxxxxxxx |
