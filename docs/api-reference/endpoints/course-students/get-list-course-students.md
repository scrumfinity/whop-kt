# GET /course_students — List course students
...
- **Operation ID:** `listCourseStudent`
...
| `course_id` | query | yes | `string` | The unique identifier of the course to list enrolled students for. | cors_xxxxxxxxxxxxx |
| `keyword` | query | no | `string \| null` | A search term to filter students by name or username. |  |
  ...
  "/course_students":
    get:
      ...
      - name: course_id
        ...
        schema:
          type: string
          description: The unique identifier of the course to list enrolled students
            for.
