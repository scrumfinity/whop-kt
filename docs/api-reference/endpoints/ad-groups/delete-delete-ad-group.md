# DELETE /ad_groups/{id} — Delete ad group
...
- **Method:** `DELETE`
- **Path:** `/ad_groups/{id}`
- **Operation ID:** `deleteAdGroup`
- **Tags:** `Ad groups`
- **Required bearer scopes:** `ad_campaign:update`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the ad group to delete. | adgrp_xxxxxxxxxxxx |
