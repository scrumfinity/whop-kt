...
properties:
  ...
  child_resource_events:
    ...
    - boolean
    - 'null'
    description: Whether or not to send events for child resources. For example, if
  ...
  resource_id:
    ...
    - string
    - 'null'
    description: The resource to create the webhook for. By default this will use
      current company
  url:
    type: string
...
properties:
  ...
  url:
    type: string
    description: The destination URL where webhook payloads are delivered via HTTP
      POST.
    example: https://example.com/path
  enabled:
    type: boolean
  ...
  child_resource_events:
    type: boolean
    description: Whether events are sent for child resources. For example, if the
      webhook is on a company, enabling this sends events only from the company's
  ...
  webhook_secret:
    type: string
    description: The secret key used to sign webhook payloads for verification. Include
      this in your HMAC validation logic.
...
- resource_id
- webhook_secret
description: A webhook endpoint that receives event notifications for a company via
  HTTP POST.
```
            ...
            application/json:
              schema:
                ...
                properties:
                  ...
                  url:
                    type: string
                    description: The destination URL where webhook payloads are delivered
                      via HTTP POST.
                    example: https://example.com/path
                  enabled:
                    type: boolean
                  ...
                  events:
                    ...
                    items:
                      "$ref": "#/components/schemas/WebhookEvent"
                    description: The list of event types this webhook is subscribed
                      to.
                  api_version:
                    "$ref": "#/components/schemas/ApiVersion"
                    description: The API version used to format payloads sent to this
                      webhook endpoint.
                  created_at:
                    type: string
                    format: date-time
                  ...
                  child_resource_events:
                    type: boolean
                    description: Whether events are sent for child resources. For
                      example, if the webhook is on a company, enabling this sends
                      events only from the company's sub-merchants (child companies).
                  testable_events:
                    type: array
                    items:
                      "$ref": "#/components/schemas/WebhookEvent"
                    description: The subset of subscribed event types that support
                      sending test payloads.
                  resource_id:
                    type: string
                    description: The ID of the resource (company or product) this
                      webhook is attached to.
                  webhook_secret:
                    type: string
                    description: The secret key used to sign webhook payloads for
                      verification. Include this in your HMAC validation logic.
                    example: whsec_abc123def456
                required:
                - id
                - url
                ...
                - resource_id
                - webhook_secret
                description: A webhook endpoint that receives event notifications
                  for a company via HTTP POST.
        '400':
              ...
              properties:
                ...
                child_resource_events:
                  ...
                  description: Whether or not to send events for child resources.
                    For example, if the webhook is created for a Company, enabling
                    this will only send events from the Company's sub-merchants (child
                    companies).
                enabled:
                  type:
                  - boolean
                ...
                resource_id:
                  ...
                  - string
                  - 'null'
                  description: The resource to create the webhook for. By default
                    this will use current company
                url:
                  type: string
                  description: The URL to send the webhook to.
                  example: https://example.com/path
