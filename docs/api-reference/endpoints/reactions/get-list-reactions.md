...
| `resource_id` | query | yes | `string` | The unique identifier of the message or forum post to list reactions for. | msg_xxxxxxxxxxxxxxxxxxxxxxxx |
...
for await (const reactionListResponse of client.reactions.list({ resource_id: 'msg_xxxxxxxxxxxxxxxxxxxxxxxx' })) {
...
page = whop.reactions.list(resource_id: "msg_xxxxxxxxxxxxxxxxxxxxxxxx")
    ...
    get:
      ...
      - name: resource_id
        ...
        schema:
          type: string
          example: msg_xxxxxxxxxxxxxxxxxxxxxxxx
          description: The unique identifier of the message or forum post to list
            reactions for.
        explode: true
        style: form
