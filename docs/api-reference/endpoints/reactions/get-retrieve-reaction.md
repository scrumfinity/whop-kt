# GET /reactions/{id} — Retrieve reaction
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the reaction to retrieve. | reac_xxxxxxxxxxxxxxxxxxxxxx |
