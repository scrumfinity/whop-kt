...
- **Operation ID:** `cancelMembership`
- **Tags:** `Memberships`
- **Required bearer scopes:** `membership:cancel`, `member:email:read`, `member:basic:read`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the membership to cancel. | mem_xxxxxxxxxxxxxx |
...
properties:
  cancellation_mode:
    ...
    - type: 'null'
    description: Whether to cancel immediately or at the end of the current billing
      period. Defaults to at_period_end.
required: []
            ...
            schema:
              ...
              properties:
                cancellation_mode:
                  ...
                  - "$ref": "#/components/schemas/MembershipCancellationModes"
                  - type: 'null'
                  description: Whether to cancel immediately or at the end of the
                    current billing period. Defaults to at_period_end.
              required: []
              description: Parameters for CancelMembership
      x-codeSamples:
      - lang: JavaScript
