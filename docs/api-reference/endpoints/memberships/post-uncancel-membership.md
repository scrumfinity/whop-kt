# POST /memberships/{id}/uncancel — Uncancel membership
...
- **Operation ID:** `uncancelMembership`
- **Tags:** `Memberships`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the membership to uncancel. | mem_xxxxxxxxxxxxxx |
