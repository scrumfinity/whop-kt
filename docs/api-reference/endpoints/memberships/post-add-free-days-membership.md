# POST /memberships/{id}/add_free_days — Add free days membership
...
- **Operation ID:** `addFreeDaysMembership`
- **Tags:** `Memberships`
- **Required bearer scopes:** `member:manage`, `member:email:read`, `member:basic:read`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the membership. | mem_xxxxxxxxxxxxxx |
...
properties:
  free_days:
    type: integer
    description: The number of free days to add (1-1095). Extends the billing period,
      expiration date, or Stripe trial depending on plan type.
    example: 42
required:
- free_days
          ...
          application/json:
            schema:
              ...
              properties:
                free_days:
                  type: integer
                  description: The number of free days to add (1-1095). Extends the
                    billing period, expiration date, or Stripe trial depending on
                    plan type.
                  example: 42
              required:
              - free_days
