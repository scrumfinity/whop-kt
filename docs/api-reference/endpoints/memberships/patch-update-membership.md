...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the membership to update. | mem_xxxxxxxxxxxxxx |
...
properties:
  metadata:
    ...
    description: A JSON object of key-value pairs to store on the membership. Replaces
            ...
            schema:
              ...
              properties:
                metadata:
                  ...
                  - 'null'
                  additionalProperties: true
                  description: A JSON object of key-value pairs to store on the membership.
