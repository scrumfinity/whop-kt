...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the membership to pause. | mem_xxxxxxxxxxxxxx |
...
properties:
  void_payments:
    ...
    - boolean
    - 'null'
    description: Whether to void any outstanding past-due payments on this membership,
      preventing future collection attempts.
required: []
            ...
            schema:
              ...
              properties:
                void_payments:
                  ...
                  - boolean
                  - 'null'
                  description: Whether to void any outstanding past-due payments on
                    this membership, preventing future collection attempts.
              required: []
              description: Parameters for PauseMembership
      x-codeSamples:
      - lang: JavaScript
