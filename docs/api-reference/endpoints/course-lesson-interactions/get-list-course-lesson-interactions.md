# GET /course_lesson_interactions — List course lesson interactions
...
- **Operation ID:** `listCourseLessonInteraction`
...
| `user_id` | query | no | `string \| null` | The unique identifier of the user to filter lesson interactions for. | user_xxxxxxxxxxxxx |
| `lesson_id` | query | no | `string \| null` | The unique identifier of the lesson to filter interactions for. | lesn_xxxxxxxxxxxxx |
| `course_id` | query | no | `string \| null` | The unique identifier of the course to filter interactions for. | cors_xxxxxxxxxxxxx |
| `completed` | query | no | `boolean \| null` | Whether to filter for completed or in-progress lesson interactions. |  |
    ...
    get:
      ...
      - name: user_id
        ...
        schema:
          ...
          - string
          - 'null'
          description: The unique identifier of the user to filter lesson interactions
            for.
          example: user_xxxxxxxxxxxxx
        explode: true
        style: form
      - name: lesson_id
        ...
        schema:
          ...
          - string
          - 'null'
          description: The unique identifier of the lesson to filter interactions
            for.
          example: lesn_xxxxxxxxxxxxx
        explode: true
        style: form
      - name: course_id
        ...
        schema:
          ...
          - string
          - 'null'
          description: The unique identifier of the course to filter interactions
            for.
