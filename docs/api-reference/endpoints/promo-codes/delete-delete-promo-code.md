# DELETE /promo_codes/{id} — Delete promo code
...
- **Method:** `DELETE`
- **Path:** `/promo_codes/{id}`
- **Operation ID:** `deletePromoCode`
- **Tags:** `Promo codes`
- **Required bearer scopes:** `promo_code:delete`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the promo code to archive. | promo_xxxxxxxxxxxx |
