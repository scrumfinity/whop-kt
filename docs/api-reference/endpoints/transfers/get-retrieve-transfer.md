# GET /transfers/{id} — Retrieve transfer
...
- **Method:** `GET`
- **Path:** `/transfers/{id}`
- **Operation ID:** `retrieveTransfer`
- **Tags:** `Transfers`
- **Required bearer scopes:** `payout:transfer:read`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the transfer to retrieve. | ctt_xxxxxxxxxxxxxx |
