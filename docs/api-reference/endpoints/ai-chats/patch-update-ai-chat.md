# PATCH /ai_chats/{id} — Update ai chat
...
- **Method:** `PATCH`
- **Path:** `/ai_chats/{id}`
- **Operation ID:** `updateAiChat`
- **Tags:** `Ai chats`
- **Required bearer scopes:** `ai_chat:update`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the AI chat to update (e.g., "ai_chat_XXXXX"). | aich_xxxxxxxxxxxxx |
            ...
            schema:
              ...
              properties:
                ...
                title:
                  ...
                  - string
                  - 'null'
                  description: The new display title for the AI chat thread (e.g.,
                    "Help with billing").
              required: []
              description: Parameters for UpdateAiChat
      x-codeSamples:
