# DELETE /ai_chats/{id} — Delete ai chat
...
- **Method:** `DELETE`
- **Path:** `/ai_chats/{id}`
- **Operation ID:** `deleteAiChat`
- **Tags:** `Ai chats`
- **Required bearer scopes:** `ai_chat:delete`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the AI chat to delete (e.g., "ai_chat_XXXXX"). | aich_xxxxxxxxxxxxx |
