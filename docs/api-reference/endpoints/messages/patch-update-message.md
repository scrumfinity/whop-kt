...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the message to update. | msg_xxxxxxxxxxxxxxxxxxxxxxxx |
...
properties:
  attachments:
    ...
    description: A replacement list of file attachments for this message, such as
      images or videos.
  content:
    type:
    - string
    - 'null'
    description: The updated body of the message in Markdown format. For example,
      'Hello **world**'.
  is_pinned:
    type:
    - boolean
...
const message = await client.messages.update('msg_xxxxxxxxxxxxxxxxxxxxxxxx');
...
message = whop.messages.update("msg_xxxxxxxxxxxxxxxxxxxxxxxx")
...
paths:
  "/messages/{id}":
    patch:
      ...
      description: Edit the content, attachments, or pinned status of an existing
        message in an experience chat, DM, or group chat channel.
      parameters:
      - name: id
        in: path
        required: true
              ...
              properties:
                attachments:
                  ...
                  items:
                    ...
                    description: Input for an attachment
                    title: FileInputWithId
                  description: A replacement list of file attachments for this message,
                    such as images or videos.
                content:
                  type:
                  - string
                  - 'null'
                  description: The updated body of the message in Markdown format.
                    For example, 'Hello **world**'.
                is_pinned:
                  type:
                  - boolean
                  - 'null'
                  description: Whether this message should be pinned to the top of
                    the channel.
              required: []
              description: Parameters for UpdateMessage
      x-codeSamples:
