# POST /experiences/{id}/attach — Attach experience
...
- **Operation ID:** `attachExperience`
- **Tags:** `Experiences`
- **Required bearer scopes:** `experience:attach`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the experience to attach. | exp_xxxxxxxxxxxxxx |
          ...
          application/json:
            schema:
              ...
              properties:
                product_id:
                  type: string
                  description: The unique identifier of the product to attach the
                    experience to.
                  example: prod_xxxxxxxxxxxxx
              required:
              - product_id
