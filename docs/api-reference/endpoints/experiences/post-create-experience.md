...
properties:
  ...
  name:
    ...
    - string
    - 'null'
    description: The display name of the experience. Defaults to the app's name if
      not provided.
  section_id:
    type:
    - string
            ...
            schema:
              ...
              properties:
                ...
                name:
                  ...
                  - string
                  - 'null'
                  description: The display name of the experience. Defaults to the
                    app's name if not provided.
                section_id:
                  type:
                  - string
                  - 'null'
                  description: The unique identifier of the section to place the experience
                    in.
              required:
              - app_id
              - company_id
