...
- **Method:** `PATCH`
- **Path:** `/experiences/{id}`
- **Operation ID:** `updateExperience`
- **Tags:** `Experiences`
- **Required bearer scopes:** `experience:update`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the experience to update. | exp_xxxxxxxxxxxxxx |
...
schemas:
  ...
  ExperienceAccessLevels:
    ...
    - public
    - private
    description: The different access levels for experiences (PUBLIC IS NEVER USED
      ANYMORE).
```
            ...
            schema:
              ...
              properties:
                ...
                is_public:
                  ...
                  - boolean
                  - 'null'
                  description: Whether the experience is publicly accessible without
                    a membership.
                logo:
                  type:
                  - object
                ...
                order:
                  ...
                  - string
                  - 'null'
                  description: The position of the experience within its section for
                    display ordering.
                  example: '1727606400000'
                section_id:
                  type:
                  - string
                  - 'null'
                  description: The unique identifier of the section to move the experience
                    into.
              required: []
              description: Parameters for UpdateExperience
      x-codeSamples:
