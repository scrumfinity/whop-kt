# POST /experiences/{id}/detach — Detach experience
...
- **Operation ID:** `detachExperience`
- **Tags:** `Experiences`
- **Required bearer scopes:** `experience:detach`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the experience to detach. | exp_xxxxxxxxxxxxxx |
          ...
          application/json:
            schema:
              ...
              properties:
                product_id:
                  type: string
                  description: The unique identifier of the product to detach the
                    experience from.
                  example: prod_xxxxxxxxxxxxx
              required:
              - product_id
