...
- **Method:** `DELETE`
- **Path:** `/experiences/{id}`
- **Operation ID:** `deleteExperience`
- **Tags:** `Experiences`
- **Required bearer scopes:** `experience:delete`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the experience to delete. | exp_xxxxxxxxxxxxxx |
