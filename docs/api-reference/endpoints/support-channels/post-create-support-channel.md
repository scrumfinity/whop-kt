# POST /support_channels — Create support channel
...
- **Operation ID:** `createSupportChannel`
- **Tags:** `Support channels`
- **Required bearer scopes:** `support_chat:create`
...
properties:
  company_id:
    type: string
    description: The unique identifier of the company to create the support channel
      in.
  ...
  user_id:
    type: string
    description: The user ID (e.g. 'user_xxxxx') or username of the customer to open
      a support channel for.
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                user_id:
                  type: string
                  description: The user ID (e.g. 'user_xxxxx') or username of the
                    customer to open a support channel for.
                  example: user_xxxxxxxxxxxxx
              required:
              - company_id
              - user_id
