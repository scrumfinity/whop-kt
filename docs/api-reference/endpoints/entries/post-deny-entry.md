# POST /entries/{id}/deny — Deny entry
...
- **Operation ID:** `denyEntry`
- **Tags:** `Entries`
- **Required bearer scopes:** `plan:waitlist:manage`, `plan:basic:read`, `member:email:read`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the waitlist entry to deny. | entry_xxxxxxxxxxxx |
...
|---|---|---|---|
| `200` | A successful response | `application/json` | `Entry` |
  ...
  Entry:
    ...
    properties:
      ...
      custom_field_responses:
        ...
        description: The list of responses collected from the user when submitting
          their waitlist entry.
    required:
    - id
    - plan
    - product
