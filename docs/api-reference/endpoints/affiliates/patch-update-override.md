...
- **Operation ID:** `updateOverrideAffiliate`
- **Tags:** `Affiliates`
- **Required bearer scopes:** `affiliate:update`
...
const override = await client.affiliates.overrides.update('affov_xxxxxxxxxxxx', {
...
override = whop.affiliates.overrides.update("affov_xxxxxxxxxxxx", id: "aff_xxxxxxxxxxxxxx")
