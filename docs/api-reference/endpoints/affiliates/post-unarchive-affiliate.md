# POST /affiliates/{id}/unarchive — Unarchive affiliate

Generated from Whop's official documented OpenAPI source: [openapi.documented.yml](../../openapi.documented.yml).

- **Base URL:** `https://api.whop.com/api/v1`
- **Method:** `POST`
- **Path:** `/affiliates/{id}/unarchive`
- **Operation ID:** `unarchiveAffiliate`
- **Tags:** `Affiliates`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The internal ID of the affiliate to archive. | aff_xxxxxxxxxxxxxx |
