...
- **Operation ID:** `deleteOverrideAffiliate`
- **Tags:** `Affiliates`
...
const override = await client.affiliates.overrides.delete('affov_xxxxxxxxxxxx', {
...
override = whop.affiliates.overrides.delete("affov_xxxxxxxxxxxx", id: "aff_xxxxxxxxxxxxxx")
