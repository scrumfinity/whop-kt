# PATCH /course_lessons/{id} — Update course lesson
...
- **Operation ID:** `updateCourseLesson`
- **Tags:** `Course lessons`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the lesson to update (e.g., "lesn_xxxxxxxxxxxxx"). | lesn_xxxxxxxxxxxxx |
...
properties:
  assessment_completion_requirement:
    ...
    properties:
      minimum_grade_percent:
        ...
        - number
        - 'null'
        description: The minimum grade percentage required to pass (0-100). Cannot
      ...
      minimum_questions_correct:
        ...
        - integer
        - 'null'
        description: The minimum number of questions that must be answered correctly.
          Cannot be set together with minimum_grade_percent.
        example: 42
    required: []
    description: The passing criteria for quiz or knowledge check lessons, such as
      minimum grade or correct answers.
  assessment_questions:
    ...
    items:
      ...
      properties:
        ...
        id:
          ...
          - string
          - 'null'
          description: The ID of an existing question. If provided, the question will
            be updated. If not provided, a new question will be created.
        image:
          type:
          - object
          - 'null'
          ...
          items:
            ...
            properties:
              id:
                ...
                - string
                - 'null'
                description: The ID of an existing option. If provided, the option
                  will be updated. If not provided, a new option will be created.
              is_correct:
                type: boolean
    ...
    description: The full list of assessment questions for quiz or knowledge check
      lessons. Replaces all existing questions.
  attachments:
    type:
    - array
    - 'null'
    items:
      ...
      title: FileInputWithId
    description: File attachments for the lesson such as PDFs or documents. Replaces
  ...
  days_from_course_start_until_unlock:
    ...
    description: The number of days after a student starts the course before this
      lesson becomes accessible.
    example: 42
  embed_id:
    type:
    - string
    - 'null'
    description: The external video identifier for embedded content (e.g., a YouTube
      video ID or Loom share ID).
  embed_type:
    oneOf:
  ...
  lesson_type:
    ...
    - type: 'null'
    description: The content type of the lesson, such as video, text, quiz, or knowledge
      check.
  main_pdf:
    type:
    - object
  ...
  max_attempts:
    ...
    - integer
    - 'null'
    description: The maximum number of attempts a student is allowed for assessment
      lessons.
    example: 42
  mux_asset_id:
    type:
    - string
    - 'null'
    description: The identifier of a Mux video asset to attach to this lesson (e.g.,
      "mux_XXXXX").
  ...
  visibility:
    ...
    - type: 'null'
    description: Controls whether this lesson is visible to students or hidden as
      a draft.
required: []
  ...
  "/course_lessons/{id}":
    patch:
      ...
      - name: id
        in: path
        required: true
        description: The unique identifier of the lesson to update (e.g., "lesn_xxxxxxxxxxxxx").
        schema:
          type: string
          example: lesn_xxxxxxxxxxxxx
            ...
            schema:
              ...
              properties:
                assessment_completion_requirement:
                  ...
                  properties:
                    minimum_grade_percent:
                      ...
                      - number
                      - 'null'
                      description: The minimum grade percentage required to pass (0-100).
                    ...
                    minimum_questions_correct:
                      ...
                      - integer
                      - 'null'
                      description: The minimum number of questions that must be answered
                        correctly. Cannot be set together with minimum_grade_percent.
                      example: 42
                  required: []
                  description: The passing criteria for quiz or knowledge check lessons,
                    such as minimum grade or correct answers.
                assessment_questions:
                  type:
                  - array
                  - 'null'
                  items:
                    ...
                    properties:
                      correct_answer:
                        type: string
                        description: The correct answer for the question. Used for
                          short answer questions
                      id:
                        type:
                        - string
                        - 'null'
                        description: The ID of an existing question. If provided,
                          the question will be updated. If not provided, a new question
                          will be created.
                      image:
                        type:
                        - object
                        ...
                        items:
                          ...
                          properties:
                            id:
                              ...
                              - string
                              - 'null'
                              description: The ID of an existing option. If provided,
                                the option will be updated. If not provided, a new
                          ...
                          - is_correct
                          - option_text
                          description: Input for creating or updating an assessment
                            question option
                        description: The answer options for multiple choice/select
                          questions
                      question_text:
                        type: string
                        description: The text of the question
                    ...
                    - question_type
                    description: Input for creating or updating an assessment question
                  description: The full list of assessment questions for quiz or knowledge
                    check lessons. Replaces all existing questions.
                attachments:
                  type:
                  - array
                  - 'null'
                  items:
                    ...
                    description: Input for an attachment
                    title: FileInputWithId
                  description: File attachments for the lesson such as PDFs or documents.
                ...
                days_from_course_start_until_unlock:
                  ...
                  - integer
                  - 'null'
                  description: The number of days after a student starts the course
                    before this lesson becomes accessible.
                  example: 42
                embed_id:
                  type:
                  - string
                  - 'null'
                  description: The external video identifier for embedded content
                    (e.g., a YouTube video ID or Loom share ID).
                embed_type:
                  oneOf:
                  - "$ref": "#/components/schemas/EmbedTypes"
                  - type: 'null'
                  description: The type of video embed for this lesson, such as YouTube
                    or Loom.
                lesson_type:
                  oneOf:
                  - "$ref": "#/components/schemas/LessonTypes"
                  - type: 'null'
                  description: The content type of the lesson, such as video, text,
                ...
                main_pdf:
                  ...
                  required:
                  - id
                  description: The primary PDF document attached to this lesson for
                    student reference.
                  title: FileInputWithId
                max_attempts:
                  type:
                  ...
                  description: The maximum number of attempts a student is allowed
                    for assessment lessons.
                  example: 42
                mux_asset_id:
                  type:
                  - string
                  - 'null'
                  description: The identifier of a Mux video asset to attach to this
                    lesson (e.g., "mux_XXXXX").
                  example: mux_xxxxxxxxxxxxxx
                thumbnail:
                  type:
                  - object
                  ...
                  required:
                  - id
                  description: The thumbnail image for the lesson in PNG, JPEG, or
                    GIF format.
                  title: FileInputWithId
                title:
                  type:
                  - string
                  - 'null'
                  description: The display title of the lesson (e.g., "Getting Started
                    with APIs").
                visibility:
                  oneOf:
                  - "$ref": "#/components/schemas/LessonVisibilities"
                  - type: 'null'
                  description: Controls whether this lesson is visible to students
                    or hidden as a draft.
              required: []
              description: Parameters for UpdateLesson
      x-codeSamples:
      - lang: JavaScript
