# POST /course_lessons — Create course lesson
...
- **Method:** `POST`
- **Path:** `/course_lessons`
- **Operation ID:** `createCourseLesson`
- **Tags:** `Course lessons`
...
properties:
  chapter_id:
    type: string
    description: The unique identifier of the chapter to create the lesson in (e.g.,
      "chap_XXXXX").
          ...
          application/json:
            schema:
              ...
              properties:
                chapter_id:
                  type: string
                  description: The unique identifier of the chapter to create the
                    lesson in (e.g., "chap_XXXXX").
                  example: chap_xxxxxxxxxxxxx
                content:
                  type:
                  - string
