# DELETE /course_lessons/{id} — Delete course lesson
...
- **Operation ID:** `deleteCourseLesson`
- **Tags:** `Course lessons`
...
|---|---|---:|---|---|---|
| `id` | path | yes | `string` | The unique identifier of the lesson to delete (e.g., "lesn_xxxxxxxxxxxxx"). | lesn_xxxxxxxxxxxxx |
  ...
  "/course_lessons/{id}":
    delete:
      ...
      - name: id
        in: path
        required: true
        description: The unique identifier of the lesson to delete (e.g., "lesn_xxxxxxxxxxxxx").
        schema:
          type: string
