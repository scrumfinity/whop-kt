...
| `course_id` | query | no | `string \| null` | The unique identifier of the course to return all lessons across all chapters. | cors_xxxxxxxxxxxxx |
| `chapter_id` | query | no | `string \| null` | The unique identifier of a chapter to return only its lessons. | chap_xxxxxxxxxxxxx |
    ...
    get:
      ...
      - name: course_id
        ...
        schema:
          ...
          - string
          - 'null'
          description: The unique identifier of the course to return all lessons across
            all chapters.
