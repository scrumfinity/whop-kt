package dev.lepshee.whop.models.products
...
data class CreateProductRequest(
    ...
    /** Member affiliate revenue percentage. */
    @SerialName("member_affiliate_percentage") val memberAffiliatePercentage: Double? = null,
    /** Member affiliate status value. */
    @SerialName("member_affiliate_status") val memberAffiliateStatus: String? = null,
    /** Product tax code ID. */
    ...
    init {
        ...
        require(memberAffiliatePercentage == null || memberAffiliatePercentage >= 0.0) {
            "Member affiliate percentage must not be negative."
        }
...
data class UpdateProductRequest(
    ...
    @SerialName("custom_cta_url") val customCtaUrl: String? = null,
    /** New custom statement descriptor shown by payment processors. */
    @SerialName("custom_statement_descriptor") val customStatementDescriptor: String? = null,
...
data class ProductPlanOptions(
    ...
    val visibility: Visibility? = null,
    /** Custom checkout fields collected for the inline plan. */
...
data class Product(
    ...
    /** Member affiliate status value. */
    @SerialName("member_affiliate_status") val memberAffiliateStatus: String? = null,
    /** Product gallery image payloads. */
    @SerialName("gallery_images") val galleryImages: List<JsonObject> = emptyList(),
    /** Product tax code payload. */
    @SerialName("product_tax_code") val productTaxCode: JsonObject? = null,
    /** Product owner user payload. */
    @SerialName("owner_user") val ownerUser: JsonObject? = null,
    /** Product company payload. */
