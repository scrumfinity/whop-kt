...
import com.lepshee.whop.models.plans.Plan
import com.lepshee.whop.models.plans.PlanOrder
import com.lepshee.whop.models.plans.PlanType
...
class PlansResource internal constructor(
    ...
    suspend fun retrieve(
        ...
        return http.get("plans/$planId", options = options)
    }
    ...
    suspend fun update(
        ...
        require(planId.isNotBlank()) { "Plan ID must not be blank." }
        return http.patch("plans/$planId", request, options)
    }
